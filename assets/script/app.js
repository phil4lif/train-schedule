$(document).ready(function () {
    ...
    $("#submit").on("click", function (e) {
        ...
        // I want each user to only see their specific saved trains.
        //create a variable that holds the userid
        userId = firebase.auth().currentUser.uid;
        console.log(userid)

        //create a variable that holds the autoid that is generated by the firebase push function
